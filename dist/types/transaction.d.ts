...
export declare type TransactionPaymentParticipantDocument = {
    /** document number */
    value?: string;
    /** Type of document provided, ie. CPF / CNPJ */
    type?: 'CPF' | 'CNPJ';
};
export declare type TransactionPaymentParticipant = {
...
export declare type TransactionPaymentData = {
...
export declare type TransactionFilters = {
